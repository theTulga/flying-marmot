...
export default function BusinessviewSectionNavigations1() {
    return (
        <React.Fragment>
            <>
                <section>
  <nav className="relative flex items-center justify-between h-20 py-4 px-6 bg-white">
    <a className="inline-block" href="#">
      <img src="coleos-assets/logos/logo-coleos-2.svg" alt />
    </a>
    <div className="hidden lg:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"><a className="inline-block mr-10 font-base font-medium text-rhino-700 hover:text-rhino-400" href="#">Categories</a><a className="inline-block mr-10 font-base font-medium text-rhino-700 hover:text-rhino-400" href="#">Products</a><a className="inline-block mr-10 font-base font-medium text-rhino-700 hover:text-rhino-400" href="#">Sales</a><a className="inline-block mr-10 font-base font-medium text-rhino-700 hover:text-rhino-400" href="#">About us</a><a className="inline-block font-base font-medium text-rhino-700 hover:text-rhino-400" href="#">Contact</a></div>
    <div className="flex pl-6 items-center">
      <a className="inline-block mr-6 text-coolGray-400 hover:text-coolGray-600" href="#">
      ...
      <a className="group relative inline-block mr-6" href="#">
        <div className="absolute top-0 right-0 -mt-2 -mr-2 inline-flex h-5 w-5 items-center justify-center rounded-full bg-orange-500 text-white text-xs font-bold">2</div>
      ...
      <a className="inline-block mr-10 text-coolGray-400 hover:text-coolGray-600" href="#">
        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
